...
exports.UserType = new graphql_1.GraphQLObjectType({
    ...
    fields: () => ({
        ...
        blogs: { type: (0, graphql_1.GraphQLList)(exports.BlogType), async resolve(parent) { return await Blog_1.default.find({ user: parent.id }); } },
        comments: { type: (0, graphql_1.GraphQLList)(exports.CommentType), async resolve(parent) { return await Comment_1.default.find({ user: parent.id }); } }
    })
});
